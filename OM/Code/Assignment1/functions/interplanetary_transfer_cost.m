...
%
%PROTOTYPE:
%[dv, delta_T] = interplanetary_transfer_cost(t_dep, t_arr, dep_planet, arr_planet, ind)
%
% DESCRIPTION:
% interplanetary_transfer_cost returns the computed delta of velocity and
% time given the two planets and the respective times of departure and
% arrival
%
% INPUTS
