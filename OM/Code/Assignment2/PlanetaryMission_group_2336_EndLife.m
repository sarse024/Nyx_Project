...
legend([plot_sec_a_effect, plot_a, plot_e], 'Secular semi-major axis', 'Semi-major axis', 'Eccentricity')
title('End-of-life evolution of the semi-major axis and eccentricity')
